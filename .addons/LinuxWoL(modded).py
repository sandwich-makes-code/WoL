...
def save_config(qemu_binary, ram_size, cpu_cores, exit_action, vm_dir=None, custom_iso_path=None, custom_driver_iso_path=None):
    config_data = {
...
class WoLGui:
    ...
    def build_ui(self):
        ...
        header = tk.Label(
            main,
            text="Windows on Linux VM Builder (modded)",
        ...
        tk.Label(selector_block, text="Any Target placeholder", font=("Segoe UI", 18, "bold"), fg=GUI_THEME["white"], bg=GUI_THEME["panel"]).pack(anchor="w", pady=(0, 12))
